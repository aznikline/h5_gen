...
save_root = '../VOC_train_hrlabel160_HDF5';
...
hr_label = zeros(size_label, size_label, 1, 1);
...
for batchno = 1:floor(count/chunksz)
    ...
    batch_hr_labels = hr_label(:,:,:,last_read+1:last_read+chunksz);
    startloc = struct('lr',[1,1,1,totalct+1],'hr',[1,1,1,totalct+1], 'label', [1,1,1,totalct+1], 'hr_label', [1,1,1,totalct+1]);
    curr_dat_sz = store2hdf5_4outputs(savepath, batch_lrs, batch_hrs, batch_labels, batch_hr_labels, ~created_flag, startloc, chunksz); 
    created_flag = true;
